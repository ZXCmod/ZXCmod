...
//	{
//		case 0:	br = 128, bg = 0, bb = 255;	break;
//		case 1:	br = 0, bg = 128, bb = 128;	break;
//		case 2:	br = 255, bg = 128, bb = 0;	break;
//		case 3:	br = 128, bg = 128, bb = 0;	break;
//		case 4:	br = 128, bg = 255, bb = 255;	break;
//	}
...
{
        Precache( );
        SET_MODEL( ENT(pev), "models/rpgrocket.mdl" );//100% 
        ...
        pev->classname = MAKE_STRING( "crowbar_rocket" );//PROJectile from BLASTER
...
void    CBlasterBeam :: Hit( CBaseEntity* Target )
{
        ...
        StartPosition = pev->origin - pev->velocity.Normalize() * 3;

        UTIL_TraceLine( StartPosition,
                        StartPosition + pev->velocity.Normalize() * 6,
...
void    CBlasterBeam :: Explode( TraceResult* TResult, int DamageType )
{
        ...
        UTIL_DecalTrace( TResult, DECAL_SCORCH1 );
	//STOP_SOUND( edict(), CHAN_VOICE, "weapons/rocket1.wav" );
	//m_Explosion;
	//EMIT_SOUND( ENT(pev), CHAN_VOICE, "weapons/explode3.wav", 0.5, ATTN_NORM);
...
void    CBlasterBeam :: MoveThink( )
{
		...
		// make rocket sound
		//EMIT_SOUND( ENT(pev), CHAN_VOICE, "weapons/rocket1.wav", 1, 0.25 );
