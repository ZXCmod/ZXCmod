...
void CScientist :: TalkInit()
{
	...
	{
	default:
	case HEAD_GLASSES:	m_voicePitch = RANDOM_LONG(75,135); break;	//glasses
	case HEAD_EINSTEIN: m_voicePitch = RANDOM_LONG(75,135); break;	//einstein
	case HEAD_LUTHER:	m_voicePitch = RANDOM_LONG(75,135);  break;	//luther
	case HEAD_SLICK:	m_voicePitch = RANDOM_LONG(75,135);  break;//slick
	}
}
...
MONSTERSTATE CScientist :: GetIdealState ( void )
{
	...
	case MONSTERSTATE_IDLE:
		...
		{
			// Stop following if you take damage //EDIT NOW!!!!
			//if ( IsFollowing() )
			//	StopFollowing( TRUE );
		}
		break;
...
void CDeadScientist :: Spawn( )
{
	...
	pev->health			= 40;//gSkillData.scientistHealth;
