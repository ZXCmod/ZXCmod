...
cvar_t	fraglimit	= {"mp_fraglimit","100", FCVAR_SERVER };
...
cvar_t	decalfrequency = {"decalfrequency","10", FCVAR_SERVER };
...
cvar_t	sk_battery1	= { "RANDOM_LONG(10,20)","0" };			
cvar_t	sk_battery2	= { "RANDOM_LONG(10,20)","0" };			
cvar_t	sk_battery3	= { "RANDOM_LONG(10,20)","0" };			

cvar_t	sk_healthcharger1	= { "RANDOM_LONG(30,100)","0" };		
cvar_t	sk_healthcharger2	= { "RANDOM_LONG(30,100)","0" };		
cvar_t	sk_healthcharger3	= { "RANDOM_LONG(30,100)","0" };			
