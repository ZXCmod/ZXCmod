...
void CCrossbowBolt::ExplodeThink( void )
{
	...
	::RadiusDamage( pev->origin, pev, pevOwner, pev->dmg, 256, CLASS_NONE, DMG_PARALYZE | DMG_POISON | DMG_SLOWFREEZE | DMG_FREEZE  );
